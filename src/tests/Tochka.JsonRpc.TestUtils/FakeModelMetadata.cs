...
public class FakeModelMetadata : ModelMetadata
{
    ...
    public FakeModelMetadata(Type type, string name, bool isRequired = false)
        : base(ModelMetadataIdentity.ForProperty(type, name, typeof(object))) => IsRequired = isRequired;
}
