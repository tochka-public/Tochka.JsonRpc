...
{
    public static readonly TestData Plain = new(true, "123", 123, 1.23, TestEnum.Two, null);

    public static readonly TestData Nested = new(true, "123", 123, 1.23, TestEnum.Two, null, NestedField: new(true, "456", 456, 4.56, TestEnum.Two, null));
}
