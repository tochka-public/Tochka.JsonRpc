...
internal sealed class RequestTests : IntegrationTestsBase<Program>
{
    ...
    [Test]
    public async Task VoidMethod_SerializeSuccessfully()
    {
        const string requestJson = """
                                   {
                                       "method": "void_method",
    ...
    [Test]
    public async Task TaskMethod_SerializeSuccessfully()
    {
        const string requestJson = """
                                   {
                                       "method": "task_method",
    ...
    [Test]
    public async Task EmptyOk_SerializeSuccessfully()
    {
        const string requestJson = """
                                   {
                                       "method": "empty_ok",
